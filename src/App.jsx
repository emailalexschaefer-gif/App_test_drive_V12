  ...
  return (
    <div ref={overlayRef} style={{position:"fixed",inset:0,zIndex:50,background:"rgba(4,14,8,0.96)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",animation:"fadeIn .3s",overflowY:"auto"}}>
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center",padding:"16px 24px 20px",width:"100%",maxWidth:390}}>
        ...
        <button onClick={(e)=>{e.stopPropagation();onClose();}} style={{width:"100%",background:"rgba(12,42,24,.85)",border:"1px solid rgba(201,168,76,.22)",borderTop:"none",borderRadius:0,borderBottomLeftRadius:14,borderBottomRightRadius:14,padding:"12px 0",...T.body,fontSize:13.5,fontWeight:700,color:"rgba(245,230,184,.82)",cursor:"pointer",letterSpacing:.2,marginBottom:24,opacity:vis?1:0,transition:"opacity .5s .62s"}}>View Full Leaderboard →</button>
        {/* Side comp card */}
        ...
        <div style={{opacity:vis?1:0,transition:"opacity .5s .72s",paddingBottom:28}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
            {[
              ...
              {label:"Share Demo",ic:"📤",msg:MSG_GROUP}
            ].map(function(opt,i){return(
              <button key={i} className="btn-press" onClick={(e)=>{e.stopPropagation();shareText(opt.msg);}} style={{width:"100%",padding:"14px 18px",background:"rgba(10,38,20,.85)",border:"1px solid rgba(201,168,76,.3)",borderRadius:12,display:"flex",alignItems:"center",gap:12,cursor:"pointer",boxShadow:"0 2px 12px rgba(0,0,0,.35)"}}>
